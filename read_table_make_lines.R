...
distances <- distance_table %>% 
  transmute(key = `key_from:From key`, 
            ...
            from_lat = `lat_from:From latitude (NAD83)`,
            from_long = `lng_from:From longitude (NAD83)`,
            to_lat = `lat_to:To latitude (NAD83)`,
            to_long = `lng_to:To longitude (NAD83)`,
